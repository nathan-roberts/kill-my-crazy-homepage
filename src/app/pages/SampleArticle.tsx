    ...
    <InternalPageLayout title="Sample Article" onNavigateHome={onNavigateHome}>
      <article className="prose prose-lg max-w-none">
        ...
        <div className="prose-content">
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">What Are Relationship Scripts?</h2>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">Identifying Your Patterns</h2>
          <p className="text-gray-300 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">Rewriting Your Story</h2>
          <p className="text-gray-300 leading-relaxed mb-6">
          ...
          <div className="bg-[#9B002F]/10 border border-[#9B002F]/30 rounded-lg p-6 my-8">
            <h3 className="text-lg font-bold text-white mb-3">Practice This Week</h3>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">The Freedom of Choice</h2>
          <p className="text-gray-300 leading-relaxed mb-6">
          ...
          <footer className="mt-12 pt-8 border-t border-gray-700">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-white">Mary Beth</p>
                  <p className="text-sm text-gray-400">Relationship Coach & Podcast Host</p>
                </div>
              </div>
