    ...
    <div className="min-h-screen bg-background font-sans relative">
      ...
      <header className="absolute top-0 left-0 right-0 z-50 px-6 py-6">
        <div className="max-w-[1550px] mx-auto flex items-center justify-between">
          ...
          <a href="#" className="px-10 py-4 bg-white text-[#9B002F] text-xs tracking-[0.15em] font-bold hover:bg-[#9B002F] hover:text-white transition-colors rounded-lg">
            SHARE YOUR STORY
          </a>
        </div>
      </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="#" className="px-10 py-4 bg-white text-[#9B002F] text-xs tracking-[0.15em] font-bold hover:bg-[#9B002F] hover:text-white transition-all rounded-lg text-center">
                  SHARE YOUR STORY
                </a>
              </div>
            </div>
